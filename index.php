...
<!--Start Banner Part -->
	<div class="homeBanner">
		...
		<div class="bannerRight">
			<div class="bannerHd" style="padding-top:100px">Welcome to Pangea</div>
			...
			<div class="fr">
            	<a href="features.php" alt="features">
                	<img src="<?php echo IMAGE_PATH; ?>learn_more_btn.gif" alt="features" border="0" vspace="25" />
            	</a>
			</div>
		</div>
	</div>
