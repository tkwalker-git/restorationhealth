...
<!--Start Banner Part -->
	<div class="homeBanner">
		...
		<div class="bannerRight">
			<div class="bannerHd" style="padding-top:37px">Welcome to Eventgrabber</div>
			<div class="bannerText">Where we match events with your personality allowing you to just click-and-go</div>
			<div class="fl"><a href="<?php echo ABSOLUTE_PATH;?>create_event.php"><img src="<?php echo IMAGE_PATH; ?>add_your_event.gif" alt="" border="0" vspace="25" /></a></div>
			...
			<div class="clr"></div>
			<img src="<?php echo IMAGE_PATH; ?>Note_FrontPage.png" width="361" height="100" alt="" border="0" vspace="25" style="padding:0px!important; margin-top:-10px" />
		</div>
		<div class="clr"></div>
	</div>
	<!--End Banner Part -->
	...
	<div class="middleConOu">
		<div class="middleContainer">
			...
			<div class="homeBotCon">
				...
				<div class="videoBox">
					<div id="player" style="border:2px solid #e9a844;">
					<iframe src="http://player.vimeo.com/video/14596016?title=0&amp;byline=0&amp;portrait=0" width="599" height="337" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>
					</div>
				</div>
				<!--End We Match Banner -->
				<!--Start getstarted -->
