					...
					if ($action1 == "save")
						{
									...
									$message = "Dear User"."<br /><br />"."Please note down your login information."."<br />"."EMAIL : ".$bc_email."<br />"."PASSWORD : ".$bc_password ."<br /><br />"."Now you can login using link below."."<br />". ABSOLUTE_PATH ."user_login.php";
