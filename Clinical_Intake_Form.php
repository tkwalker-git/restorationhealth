...
$clinicid		= attribValue('patients', 'clinicid', "where id='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."'");
$emr_pt_id 		= attribValue('patients', 'genensysuserid', "where id='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."'");
$emr_clinic_id	= attribValue('users', 'emr_clinic_id', "where id='". $clinicid ."'");
...
{
	$link="https://yourhealthsupport.com:8443/PatientForms/DisplayForm.jsp?encountertemplate=Male%20Initial&schemaname=". $emr_clinic_id ."&patientId=".$emr_pt_id;
}
else
{
	$link="https://yourhealthsupport.com:8443/PatientForms/DisplayForm.jsp?encountertemplate=Female%20Initial&schemaname=". $emr_clinic_id ."&patientId=".$emr_pt_id;
}
        ...
        <div class="whiteBottom">
          <div class="whiteMiddle" style="padding-top:7px;">
			<div style="padding-bottom:50px; overflow:hidden;">
				<iframe src="<?php echo $link; ?>" id="para1" frameborder=0 width="900px" height="8675px" ></iframe>			</div>
          </div>
        </div>
      </div>
    </div>
