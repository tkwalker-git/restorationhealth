...
if($_GET['p']=='requests' && $_GET['del']!=''){
	$r_del =  $_GET['del'];
	
	mysql_query("delete from request_appt where clinic_id='".$_SESSION['LOGGEDIN_MEMBER_ID']."' && id='".$r_del."'  ");
					...
					&nbsp;Accept Request<br />	<br />
											...
											<br />
											<a href="clinic_manager.php?p=requests&del=<?php echo $rid; ?>">Delete Request</a>
