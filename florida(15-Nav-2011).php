...
$meta_title 	=	"Florida Classic 2011 - Events";
...
$(document).ready(function(){
	...
	$('#view_event_guide').click(function(){
	$.ajax({  
			type: "GET",  
    ...
    <div class="contentWrapper" style="text-align:left">
      ...
      <div class="whitePages">
		...
		?>
            ...
            <?php
			if($showButton=='yes'){?>
            <img src="<?php echo IMAGE_PATH; ?>viewall_btn.png" id="view_event_guide" style="cursor:pointer" width="110" height="42" border="0" />
            <?php } ?>
          </div>
          <!--end eventGuideLeft-->
