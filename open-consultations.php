...
strong{
    ...
    <?php
                                    ...
                                    $sql = "select * from patient_comments where comment_date ='$today' &&  status <= '1' && clinic_id='$member_id' group by patient_id";
                                    ...
                                    while($row = mysql_fetch_array($res)){
									 $todayd = date("Y-m-d");
										...
										$reason			= getSingleColumn("reason","select * from `request_appt` where 'patient_id'='$patient_id' && clinic_id='".$_SESSION['LOGGEDIN_MEMBER_ID']."'");
