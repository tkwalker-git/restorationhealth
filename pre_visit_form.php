...
/* $link="https://pangeaifa.com:8443/PatientForms/DisplayForm.jsp?encountertemplate=Followup&schemaname=pangeafinal2&patientId=".$member_id."&encounterDate=".$pdate; */
 ...
 $link="https://yourhealthsupport.com:8443/PatientForms/DisplayForm.jsp?encountertemplate=Followup&schemaname=". $emr_clinic_id ."&patientId=".$emr_pt_id."&encounterDate=".$date;
