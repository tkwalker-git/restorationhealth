...
$date=date("Y-m-d");
mysql_query("insert into patient_comments set patient_id='".$_GET['id']."',clinic_id ='".$_SESSION['LOGGEDIN_MEMBER_ID']."',comment_date='".$date."',comment ='".$comment."' , review_status=3");
