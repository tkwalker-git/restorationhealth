...
/* if ( trim($agree) == '' ) $errors[] = 'Please Accept Terms and Policy.'; */
...
<div class="welcomeBox"></div>
  ...
  <div id="middleContainer">
    <div class="creatAnEventMdl" style="font-size:55px; text-align:center; width:100%"> Your Health Support Subscription <br />
...
<table width="92%" border="0" cellspacing="15" cellpadding="0" align="center">
  <tr>
    <td width="46%">
	<strong>Please Enter Your Product Code</strong>:<br /><input type="text" name="coupon" class="new_input1" value="<?php echo $product_code; ?>" />
	<input type="button" value="Get Product" onclick="test()"/><br>
    ...
    <td width="46%">&nbsp;</td>
				...
				<div class="pro_duct">
					<input type="radio" name="clinic_product" value="<?php echo $key; ?>" <?php if($bc_clinic_product==$key || $i==$b){?> checked="checked" <?php } ?> />&nbsp;
