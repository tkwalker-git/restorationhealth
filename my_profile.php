<?php
	...
	if ( isset($_POST['continue']) )
	{
		...
		$EMRClinicID 	= UpdateDoctor($emr_clinic_id,$emr_doctor_id,$fname,$lname,$email,$gender,$dob2,$email,$password);
	...
	$sql = "update users set phone='$phone',address='$address',city='$city',zip='$zip',firstname='$fname',lastname='$lname',email='$email',sex='$gender',".  $pwd ."dob='$dob' " . $sql_img . " where id='". $member_id ."'";
			if ( mysql_query($sql) ){
	...
	if ( $row = mysql_fetch_assoc($res) ) {
		...
		$sub_type	= DBout($row['subscription_type']);
...
<div class="error"><?php echo $err; ?></div>
    ...
    <div class="editProox">
      ...
      <div class="evLabal">
        <input type="text" name="fname" class="evInput" style="width:300px; height:20px" value='<?php echo $fname;?>' />
      </div>
      <div class="clr"></div>
